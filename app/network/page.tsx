...
const NetworkSecurityPage = () => {
  ...
  const sendEmail = (e:any) => {
    ...
    emailjs
      .sendForm(
        "service_1g1w89u", // replace with your EmailJS Service ID
        "template_knmfq55", // replace with your EmailJS Template ID
        e.target,
        "J-f43ZlJRbLTKjrDa" // replace with your EmailJS User ID (public key)
      )
      .then(
        (result) => {
    ...
    <>
      ...
      <section className="stn-hero">
        ...
        <div className="stn-hero-container">
          <div className="stn-text">
            ...
            <p>
              Systemizer Technic specializes in helping companies modernise
              technology, reimagine processes and transform experiences. We're
              on a mission to drive innovation through technology — streamlining
              operations, supercharging growth, and putting your business at the
        ...
        <div className="stn-services-container">
          <div className="service-card">
            ...
            <p>
              ...
              designed to take the heavy lifting off your hands. We are
              Systemizer Technic — engineering modern IT solutions with a focus
              on results, experience, and value.
            </p>
          </div>
          <div className="service-card">
            <p>
      ...
      <section className="stn-email">
        ...
        <form onSubmit={sendEmail}>
          <input
            type="email"
            name="from_email" // match this to your EmailJS template variable
